...
namespace Argon2Id.Security
{
    ...
    public class ApplicationMembershipProviderBase : MembershipProvider
    {
        ...
        protected virtual SqlStatement CreateSqlStatement(MembershipProviderSqlStatement command)
        {
            ...
            sql.Name = ("Argon2Id Application Membership Provider - " + command.ToString());
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(name))
                name = "Argon2IdApplicationMembershipProvider";
            if (string.IsNullOrEmpty(config["description"]))
            {
                config.Remove("description");
                config.Add("description", "Argon2Id application membership provider");
            }
