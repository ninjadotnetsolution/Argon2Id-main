...
namespace Argon2Id.Handlers
{
    ...
    public class SiteBase : Argon2Id.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "&copy; 2023 Argon2Id. ^Copyright^All rights reserved.^Copyright^";
            }
        }
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            var themePath = Server.MapPath("~/App_Themes/Argon2Id");
            if (Directory.Exists(themePath))
                foreach (var stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!fileName.Equals("_Theme_Aquarium.css"))
                    {
                        ...
                        {
                            Href = ("~/App_Themes/Argon2Id/" + fileName)
                        };
