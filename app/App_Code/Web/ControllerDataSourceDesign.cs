    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                var res = GetType().Assembly.GetManifestResourceStream(string.Format("Argon2Id.Controllers.{0}.xml", DataController));
                if (res == null)
                    res = GetType().Assembly.GetManifestResourceStream(string.Format("Argon2Id.{0}.xml", DataController));
                if (res != null)
