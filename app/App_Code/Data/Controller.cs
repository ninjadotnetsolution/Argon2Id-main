...
namespace Argon2Id.Data
{
    public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                    res = ControllerConfigurationUtility.GetResourceStream(string.Format("Argon2Id.controllers.{0}.xml", controller), string.Format("Argon2Id.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
                t = typeof(Argon2Id.Data.Controller);
            var res = ControllerConfigurationUtility.GetResourceStream(string.Format("Argon2Id.Reports.{0}", name), string.Format("Argon2Id.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                var config = Argon2Id.Data.Controller.CreateConfigurationInstance(t, controller);
