...
using Argon2Id.Services;

namespace Argon2Id.Data
{
    ...
    public partial class DataControllerBase : IDataController, IAutoCompleteManager, IDataEngine, IBusinessObject
    {
        ...
        public virtual string GetSurvey(string surveyName)
        {
            ...
            if (string.IsNullOrEmpty(survey))
                survey = ControllerConfigurationUtility.GetResourceText(string.Format("Argon2Id.Surveys.{0}.min.js", surveyName), string.Format("Argon2Id.{0}.min.js", surveyName), string.Format("Argon2Id.Surveys.{0}.js", surveyName), string.Format("Argon2Id.{0}.js", surveyName));
            if (string.IsNullOrEmpty(survey))
                throw new HttpException(404, "Not found.");
            if (string.IsNullOrEmpty(layout))
                layout = ControllerConfigurationUtility.GetResourceText(string.Format("Argon2Id.Surveys.{0}.html", surveyName), string.Format("Argon2Id.Surveys.{0}.htm", surveyName), string.Format("Argon2Id.{0}.html", surveyName), string.Format("Argon2Id.{0}.htm", surveyName));
            if (string.IsNullOrEmpty(rules))
                rules = ControllerConfigurationUtility.GetResourceText(string.Format("Argon2Id.Surveys.{0}.rules.min.js", surveyName), string.Format("Argon2Id.{0}.rules.min.js", surveyName), string.Format("Argon2Id.Surveys.{0}.rules.js", surveyName), string.Format("Argon2Id.{0}.rules.js", surveyName));
